...
Yes. Set `spec.specVersion` to `3` or `3.1` in your `tsoa.json` file. See more config options in the [`Config`](../reference/tsoa-next/interfaces/Config.md) API reference.
