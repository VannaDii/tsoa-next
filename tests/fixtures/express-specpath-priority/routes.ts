...
export function RegisterRoutes(app: Router,opts?:{validation?: Tsoa.ValidationContext}) {
    ...
    for (const specPath of fetchSpecPaths(SpecPathPriorityDynamicController)) {
        ...
        app.get(specFullPath, async function SpecPathPriorityDynamicController_specPath(request: ExRequest, response: ExResponse, next: any) {
            try {
    ...
    for (const specPath of fetchSpecPaths(SpecPathController)) {
        ...
        app.get(specFullPath, async function SpecPathController_specPath(request: ExRequest, response: ExResponse, next: any) {
            try {
                const specResponse = await resolveSpecPathResponse({
        ...
        app.get('/v1/:tenant/:resource',
            ...(fetchMiddlewares<RequestHandler>(SpecPathPriorityDynamicController)),
            ...(fetchMiddlewares<RequestHandler>(SpecPathPriorityDynamicController.prototype.getDynamicRouteMatch)),

            async function SpecPathPriorityDynamicController_getDynamicRouteMatch(request: ExRequest, response: ExResponse, next: any) {

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsSpecPathPriorityDynamicController_getDynamicRouteMatch, controllerClass: SpecPathPriorityDynamicController, methodName: 'getDynamicRouteMatch', request, response });
        ...
        app.get('/v1/SpecPath',
            ...(fetchMiddlewares<RequestHandler>(SpecPathController)),
            ...(fetchMiddlewares<RequestHandler>(SpecPathController.prototype.getControllerStatus)),

            async function SpecPathController_getControllerStatus(request: ExRequest, response: ExResponse, next: any) {

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsSpecPathController_getControllerStatus, controllerClass: SpecPathController, methodName: 'getControllerStatus', request, response });
